...
const int8_t _mes_menu_select_demo_1_selected[] PROGMEM = "*P01 : Demo    ";
const int8_t _mes_menu_select_demo_1_not_selected[] PROGMEM = " P01 : Demo    ";
...
void menu(void)
{
	...
	strcpy_P(_mes_menu,_mes_menu_select_demo_1_selected);
